        ...
        <div className='mx-auto box-content px-4 lg:w-[1260px]'>
          <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start xl:max-w-[810px]'>
            ...
            <div className='relative block max-h-[30rem] lg:hidden'>
              ...
              <img src={thumbnail} alt={`${courseName} thumbnail`} className='aspect-auto w-full' />
            </div>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex flex-wrap justify-between gap-2'>
                <div className='flex gap-2'>
                  ...
                  <span>{courseData?.data?.totalDuration || "N/A"} total length</span>
                </div>
                <div>
                  ...
                  <div onClick={() => handleActive(section._id)}>
                    <div className='flex cursor-pointer items-start justify-between bg-opacity-20 px-7 py-6 transition-[0.3s]'>
                      <div className='flex items-center gap-2'>
                        <i className={isActive.includes(section._id) ? "-rotate-90" : "rotate-90"}>
