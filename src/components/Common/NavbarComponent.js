/**
 * Special Navbar Component for Vercel deployment
 * This file is created specifically to fix path resolution issues in Vercel
 * It is a duplicate of the Navbar.jsx content but with a .js extension
 */
